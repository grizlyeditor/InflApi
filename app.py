...
def get_account_credentials(region: str) -> str:
    r = region.upper()
    if r == "ME":
        return "uid=4233761573&password=BY_GRIZLY-AZWZR01UH-GRIZLY"
    elif r == "BD":
        return "uid=4233763411&password=BY_GRIZLY-PEH25EXHG-GRIZLY"
    elif r in {"BR", "US", "SAC", "ME"}:
        return "uid=4233765246&password=BY_GRIZLY-EOTNZ7MIT-GRIZLY"
    else:
        return "uid=4233765833&password=BY_GRIZLY-3YK5GUNMG-GRIZLY"
